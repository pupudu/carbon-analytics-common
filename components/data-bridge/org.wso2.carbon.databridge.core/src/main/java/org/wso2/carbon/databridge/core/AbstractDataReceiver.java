...
public abstract class AbstractDataReceiver implements DataBridgeReceiverService {
	...
	@Override public String defineStream(String sessionId, String streamDefinition)
	...
	@Override public String findStreamId(String sessionId, String streamName, String streamVersion)
			throws SessionTimeoutException {
		return getDatabridgeReceiver().findStreamId(sessionId, streamName, streamVersion);
	}

	@Override public boolean deleteStream(String sessionId, String streamId)
			throws SessionTimeoutException {
		return getDatabridgeReceiver().deleteStream(sessionId, streamId);
	}

	@Override public boolean deleteStream(String sessionId, String streamName, String streamVersion)
			throws SessionTimeoutException {
		return getDatabridgeReceiver().deleteStream(sessionId, streamName, streamVersion);
	}

	@Override public void publish(Object eventBundle, String sessionId,
	...
	@Override public String login(String username, String password) throws AuthenticationException {
		return getDatabridgeReceiver().login(username, password);
	}

	@Override public void logout(String sessionId) throws Exception {
	...
	@Override public DataBridgeConfiguration getInitialConfig() {
