...
public class ThriftEventTransmissionServiceImpl implements ThriftEventTransmissionService.Iface {
	...
	@Override public String findStreamId(String sessionId, String streamName, String streamVersion)
		...
		try {
			String streamDefinition =
					dataBridgeReceiverService.findStreamId(sessionId, streamName, streamVersion);
			if (streamDefinition == null) {
				//this is used as Thrift cannot send null values
				throw new ThriftNoStreamDefinitionExistException(
						"Stream definition not exist for " + streamName + " " + streamVersion);
			}
	...
	@Override public boolean deleteStreamById(String sessionId, String streamId)
			throws ThriftSessionExpiredException, TException {
		try {
	...
	@Override public boolean deleteStreamByNameVersion(String sessionId, String streamName,
	...
	public void publish(ThriftEventBundle eventBundle)
		...
		try {
			dataBridgeReceiverService
					.publish(eventBundle, eventBundle.getSessionId(), eventConverter);
