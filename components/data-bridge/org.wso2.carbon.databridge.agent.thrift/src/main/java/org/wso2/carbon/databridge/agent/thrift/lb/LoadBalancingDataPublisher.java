...
public class LoadBalancingDataPublisher {
	...
	public void publish(String streamName, String streamVersion, long timeStamp,
		...
		for (ReceiverGroup aGroup : receiverGroups) {
			aGroup.publish(streamName, streamVersion, timeStamp, metaDataArray,
	...
	public void publish(String streamName, String streamVersion, long timeStamp,
		...
		for (ReceiverGroup aGroup : receiverGroups) {
			aGroup.publish(streamName, streamVersion, timeStamp, metaDataArray,
			               correlationDataArray, payloadDataArray, null);
		}
	}
	...
	public void publish(String streamName, String streamVersion, Object[] metaDataArray,
		...
		for (ReceiverGroup aGroup : receiverGroups) {
			aGroup.publish(streamName, streamVersion, metaDataArray, correlationDataArray,
