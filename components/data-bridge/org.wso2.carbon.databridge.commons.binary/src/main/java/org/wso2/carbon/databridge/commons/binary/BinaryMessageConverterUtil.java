...
public class BinaryMessageConverterUtil {
	...
	public static String getCompleteError(String message, Exception ex) {
		...
		error.append(BinaryMessageConstants.ERROR_EXCEPTION_CLASS)
		     .append(ex.getClass().getCanonicalName()).append("\n");
		error.append(BinaryMessageConstants.ERROR_MESSAGE).append(message).append("\n");
		error.append(BinaryMessageConstants.ERROR_EXCEPTION_TRACE)
		     .append(ex.getStackTrace().toString()).append("\n");
