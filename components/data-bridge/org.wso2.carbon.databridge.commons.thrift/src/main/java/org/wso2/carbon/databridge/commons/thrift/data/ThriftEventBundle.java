...
public class ThriftEventBundle
		implements org.apache.thrift.TBase<ThriftEventBundle, ThriftEventBundle._Fields>,
	...
	private static final org.apache.thrift.protocol.TField INT_ATTRIBUTE_LIST_FIELD_DESC =
			new org.apache.thrift.protocol.TField("intAttributeList",
	...
	private static final org.apache.thrift.protocol.TField LONG_ATTRIBUTE_LIST_FIELD_DESC =
			new org.apache.thrift.protocol.TField("longAttributeList",
	...
	private static final org.apache.thrift.protocol.TField DOUBLE_ATTRIBUTE_LIST_FIELD_DESC =
			new org.apache.thrift.protocol.TField("doubleAttributeList",
	...
	private static final org.apache.thrift.protocol.TField BOOL_ATTRIBUTE_LIST_FIELD_DESC =
			new org.apache.thrift.protocol.TField("boolAttributeList",
	...
	private static final org.apache.thrift.protocol.TField STRING_ATTRIBUTE_LIST_FIELD_DESC =
			new org.apache.thrift.protocol.TField("stringAttributeList",
	...
	private static final org.apache.thrift.protocol.TField ARBITRARY_DATA_MAP_MAP_FIELD_DESC =
			new org.apache.thrift.protocol.TField("arbitraryDataMapMap",
	...
	static {
		...
		tmpMap.put(_Fields.INT_ATTRIBUTE_LIST,
		           new org.apache.thrift.meta_data.FieldMetaData("intAttributeList",
		                                                         org.apache.thrift.TFieldRequirementType.OPTIONAL,
		                                                         new org.apache.thrift.meta_data.ListMetaData(
				                                                         org.apache.thrift.protocol.TType.LIST,
				                                                         new org.apache.thrift.meta_data.FieldValueMetaData(
						                                                         org.apache.thrift.protocol.TType.I32))));
		tmpMap.put(_Fields.LONG_ATTRIBUTE_LIST,
		           new org.apache.thrift.meta_data.FieldMetaData("longAttributeList",
		                                                         org.apache.thrift.TFieldRequirementType.OPTIONAL,
		                                                         new org.apache.thrift.meta_data.ListMetaData(
				                                                         org.apache.thrift.protocol.TType.LIST,
				                                                         new org.apache.thrift.meta_data.FieldValueMetaData(
						                                                         org.apache.thrift.protocol.TType.I64))));
		tmpMap.put(_Fields.DOUBLE_ATTRIBUTE_LIST,
		           new org.apache.thrift.meta_data.FieldMetaData("doubleAttributeList",
		                                                         org.apache.thrift.TFieldRequirementType.OPTIONAL,
		                                                         new org.apache.thrift.meta_data.ListMetaData(
				                                                         org.apache.thrift.protocol.TType.LIST,
				                                                         new org.apache.thrift.meta_data.FieldValueMetaData(
						                                                         org.apache.thrift.protocol.TType.DOUBLE))));
		tmpMap.put(_Fields.BOOL_ATTRIBUTE_LIST,
		           new org.apache.thrift.meta_data.FieldMetaData("boolAttributeList",
		                                                         org.apache.thrift.TFieldRequirementType.OPTIONAL,
		                                                         new org.apache.thrift.meta_data.ListMetaData(
				                                                         org.apache.thrift.protocol.TType.LIST,
				                                                         new org.apache.thrift.meta_data.FieldValueMetaData(
						                                                         org.apache.thrift.protocol.TType.BOOL))));
		tmpMap.put(_Fields.STRING_ATTRIBUTE_LIST,
		           new org.apache.thrift.meta_data.FieldMetaData("stringAttributeList",
		                                                         org.apache.thrift.TFieldRequirementType.OPTIONAL,
		                                                         new org.apache.thrift.meta_data.ListMetaData(
				                                                         org.apache.thrift.protocol.TType.LIST,
				                                                         new org.apache.thrift.meta_data.FieldValueMetaData(
						                                                         org.apache.thrift.protocol.TType.STRING))));
		tmpMap.put(_Fields.ARBITRARY_DATA_MAP_MAP,
		           new org.apache.thrift.meta_data.FieldMetaData("arbitraryDataMapMap",
		                                                         org.apache.thrift.TFieldRequirementType.OPTIONAL,
		...
		org.apache.thrift.meta_data.FieldMetaData
				.addStructMetaDataMap(ThriftEventBundle.class, metaDataMap);
	}
	...
	public ThriftEventBundle(ThriftEventBundle other) {
		...
		if (other.isSetArbitraryDataMapMap()) {
			...
			for (Map.Entry<Integer, Map<String, String>> other_element : other.arbitraryDataMapMap
					.entrySet()) {
				...
				Map<String, String> __this__arbitraryDataMapMap_copy_value =
						new HashMap<String, String>();
				for (Map.Entry<String, String> other_element_value_element : other_element_value
						.entrySet()) {
					...
					String __this__arbitraryDataMapMap_copy_value_copy_key =
							other_element_value_element_key;

					String __this__arbitraryDataMapMap_copy_value_copy_value =
							other_element_value_element_value;

					__this__arbitraryDataMapMap_copy_value
							.put(__this__arbitraryDataMapMap_copy_value_copy_key,
							     __this__arbitraryDataMapMap_copy_value_copy_value);
				}
	...
	public ThriftEventBundle setArbitraryDataMapMap(
			Map<Integer, Map<String, String>> arbitraryDataMapMap) {
	...
	public int compareTo(ThriftEventBundle other) {
		...
		if (isSetSessionId()) {
			lastComparison =
					org.apache.thrift.TBaseHelper.compareTo(this.sessionId, typedOther.sessionId);
			if (lastComparison != 0) {
				return lastComparison;
			}
		}
		...
		if (isSetEventNum()) {
			lastComparison =
					org.apache.thrift.TBaseHelper.compareTo(this.eventNum, typedOther.eventNum);
			if (lastComparison != 0) {
				return lastComparison;
			}
		}
		lastComparison = Boolean.valueOf(isSetIntAttributeList())
		                        .compareTo(typedOther.isSetIntAttributeList());
		if (lastComparison != 0) {
			return lastComparison;
		}
		if (isSetIntAttributeList()) {
			lastComparison = org.apache.thrift.TBaseHelper
					.compareTo(this.intAttributeList, typedOther.intAttributeList);
			if (lastComparison != 0) {
				return lastComparison;
			}
		}
		lastComparison = Boolean.valueOf(isSetLongAttributeList())
		                        .compareTo(typedOther.isSetLongAttributeList());
		if (lastComparison != 0) {
			return lastComparison;
		}
		if (isSetLongAttributeList()) {
			lastComparison = org.apache.thrift.TBaseHelper
					.compareTo(this.longAttributeList, typedOther.longAttributeList);
			if (lastComparison != 0) {
				return lastComparison;
			}
		}
		lastComparison = Boolean.valueOf(isSetDoubleAttributeList())
		                        .compareTo(typedOther.isSetDoubleAttributeList());
		if (lastComparison != 0) {
			return lastComparison;
		}
		if (isSetDoubleAttributeList()) {
			lastComparison = org.apache.thrift.TBaseHelper
					.compareTo(this.doubleAttributeList, typedOther.doubleAttributeList);
			if (lastComparison != 0) {
				return lastComparison;
			}
		}
		lastComparison = Boolean.valueOf(isSetBoolAttributeList())
		                        .compareTo(typedOther.isSetBoolAttributeList());
		if (lastComparison != 0) {
			return lastComparison;
		}
		if (isSetBoolAttributeList()) {
			lastComparison = org.apache.thrift.TBaseHelper
					.compareTo(this.boolAttributeList, typedOther.boolAttributeList);
			if (lastComparison != 0) {
				return lastComparison;
			}
		}
		lastComparison = Boolean.valueOf(isSetStringAttributeList())
		                        .compareTo(typedOther.isSetStringAttributeList());
		if (lastComparison != 0) {
			return lastComparison;
		}
		if (isSetStringAttributeList()) {
			lastComparison = org.apache.thrift.TBaseHelper
					.compareTo(this.stringAttributeList, typedOther.stringAttributeList);
			if (lastComparison != 0) {
				return lastComparison;
			}
		}
		lastComparison = Boolean.valueOf(isSetArbitraryDataMapMap())
		                        .compareTo(typedOther.isSetArbitraryDataMapMap());
		if (lastComparison != 0) {
			return lastComparison;
		}
		if (isSetArbitraryDataMapMap()) {
			lastComparison = org.apache.thrift.TBaseHelper
					.compareTo(this.arbitraryDataMapMap, typedOther.arbitraryDataMapMap);
			if (lastComparison != 0) {
				return lastComparison;
			}
		}
					...
					if (field.type == org.apache.thrift.protocol.TType.MAP) {
						{
							...
							this.arbitraryDataMapMap =
									new HashMap<Integer, Map<String, String>>(2 * _map15.size);
	...
	public void write(org.apache.thrift.protocol.TProtocol oprot)
			...
			if (isSetIntAttributeList()) {
				oprot.writeFieldBegin(INT_ATTRIBUTE_LIST_FIELD_DESC);
				{
					oprot.writeListBegin(new org.apache.thrift.protocol.TList(
							org.apache.thrift.protocol.TType.I32, this.intAttributeList.size()));
		...
		if (this.longAttributeList != null) {
			if (isSetLongAttributeList()) {
				...
				{
					oprot.writeListBegin(new org.apache.thrift.protocol.TList(
							org.apache.thrift.protocol.TType.I64, this.longAttributeList.size()));
		...
		if (this.boolAttributeList != null) {
			if (isSetBoolAttributeList()) {
				...
				{
					oprot.writeListBegin(new org.apache.thrift.protocol.TList(
							org.apache.thrift.protocol.TType.BOOL, this.boolAttributeList.size()));
			...
			if (isSetArbitraryDataMapMap()) {
				oprot.writeFieldBegin(ARBITRARY_DATA_MAP_MAP_FIELD_DESC);
				{
					oprot.writeMapBegin(new org.apache.thrift.protocol.TMap(
							org.apache.thrift.protocol.TType.I32,
							org.apache.thrift.protocol.TType.MAP, this.arbitraryDataMapMap.size()));
					for (Map.Entry<Integer, Map<String, String>> _iter28 : this.arbitraryDataMapMap
							.entrySet()) {
						oprot.writeI32(_iter28.getKey());
						{
							oprot.writeMapBegin(new org.apache.thrift.protocol.TMap(
									org.apache.thrift.protocol.TType.STRING,
									org.apache.thrift.protocol.TType.STRING,
									_iter28.getValue().size()));
							for (Map.Entry<String, String> _iter29 : _iter28.getValue()
							                                                .entrySet()) {
