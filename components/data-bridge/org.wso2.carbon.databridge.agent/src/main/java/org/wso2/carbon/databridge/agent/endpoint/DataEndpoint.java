...
public abstract class DataEndpoint {
	...
	void connect()
			throws TransportException, DataEndpointAuthenticationException, DataEndpointException {
	 ...
	 */
	protected abstract void send(Object client, List<Event> events)
	...
	private Object getClient() throws DataEndpointException {
		try {
			...
			throw new DataEndpointException(
					"Cannot borrow client for " + getDataEndpointConfiguration().getPublisherKey(),
					e);
		}
	}
